...
if [ ! -r GetComponents ]
then
  curl -LO https://raw.githubusercontent.com/gridaphobe/CRL/ET_2026_05/GetComponents
  chmod a+x GetComponents
fi
rm -f einsteintoolkit.th
curl -LO https://bitbucket.org/einsteintoolkit/manifest/raw/ET_2026_05/einsteintoolkit.th
#curl -LO https://raw.githubusercontent.com/gridaphobe/CRL/master/GetComponents
chmod a+x GetComponents
if [ ! -d Cactus ]
then
  ./GetComponents --parallel --no-shallow ./einsteintoolkit.th
fi
cd Cactus
